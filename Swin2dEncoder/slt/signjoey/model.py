...
from signjoey.encoders import Encoder, RecurrentEncoder, TransformerEncoder, SwinTransformerEncoder
...
def build_model(
    ...
    sgn_embed: SpatialEmbeddings = SpatialEmbeddings(
        ...
        scale=cfg["encoder"]["embeddings"]["scale"],
        norm_type=cfg["encoder"]["embeddings"]["norm_type"],
        activation_type=cfg["encoder"]["embeddings"]["activation_type"],
        num_heads=cfg["encoder"]["num_heads"],
        input_size=cfg["encoder"]["embeddings"]["input_size"],
    )
